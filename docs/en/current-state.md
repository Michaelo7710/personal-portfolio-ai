...
Portfolio is a Next.js boilerplate built specifically for Indonesian developers. Phases 1–4 are complete. The repository now includes:
...
- Landing page at `/` with Portfolio branding, shared `Header` and `Footer`
